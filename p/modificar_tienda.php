...
<div class="settWrap editStoreWrap">
	...
	<form class="storeEditForm tabWrap storeEditSec transTw storeInfoSec" action="/i/p/store_func/update_store_info.php" method="POST">
	...
	<form class="storeEditForm tabWrap storeEditSec transTw storeSocialSec hidden" action="/i/p/store_func/update_store_social.php" method="POST">
		<div>
	...
	<form class="storeImageForm tabWrap storeEditSec transTw storeAppearanceSec hidden" action="/i/p/store_func/update_store_images.php" enctype="multipart/form-data" method="POST"> 
		...
		<div class="pictureUploadWrap">
			...
			<div class="actualImage profPicWrap">
				...
				{
					?>
					<img src="/i/images/profile/thumb/<?php echo $usuario->imagen ?>" style="left: -<?php echo $usuario->imagencoordx; ?>px; top: -<?php echo $usuario->imagencoordy; ?>px">
					<?php
				} 
				...
				<img width="150" src="/i/images/resources/storePNG.png" />
		...
		<div class="pictureUploadWrap">
			...
			<div class="actualImage bannerImgWrap">
				...
				{
					?>
					<img src="/i/images/banners/thumb/<?php echo $usuario->banner1 ?>" style="left: -<?php echo $usuario->bannercoordx; ?>px; top: -<?php echo $usuario->bannercoordy; ?>px">
					<?php
				}
				...
				<img width="533" src="/i/images/resources/defaultBanner.png" />
...
<script> //displays cities/province list on click
	$('.listProvincia').click(function()
	{
		...
		$.ajax({
			type: "POST",
			url: "/i/p/store_func/show_sector.php",
			data: {idprovincia : id}
		}).done(function(html)
		{
