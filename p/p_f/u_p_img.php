			...
			$pos = ($modVal - $baseDimm)/2;
                ...
                <div class="uplddImgWrap">
                	...
                	<span class="itmImageMask imageDefaultMask">
                    	<img class="imageProduct imageDefault itmImage" <?php if($heightO > $widthO){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/productos/thumb150/<?php echo $imgs->img_temporales ?>">
                	</span>
                </div>
