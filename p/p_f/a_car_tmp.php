<?php 
		...
		if($session["autenticado"])
		{
            ...
            $caracteristica_temp = $query3->fetch(PDO::FETCH_OBJ);
				?>
				<form class="caracteristica xtraCharacDetail characDetail transTw hidden" action="/i/p/p_f/upl_caract.php">
					...
					<div class="imgCaract imgChWrap<?php echo $_POST["cont"] ?>" data-id="imgChWrap<?php echo $_POST["cont"] ?>">
			    		<?php
							...
							{
								?>
								<img src="/i/images/c_prod/thumb150/<?php echo $iC->imagen ?>">
								<?php
							}
						?>
			    	</div>	
