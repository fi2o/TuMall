...
?>
    <script src="/i/Scripts/jquery.form.img.js"></script>
	
	
	
	<div class="topBar">
		<!-- <a href="/i/productos/lista" class="formActionBtn">Cancelar</a> -->
		<h2 class="settHead">Publicar artículos</h2>
	</div>
	<div class="settWrap addItemsWrap">
    <form method="post" action="/i/p/p_f/i_p1.php" class="itmDetailForm" >
	    ...
	    <div class="addImgWrap itmFormSec fluidTransTw 3 hidden" data-id="3">
		    ...
		    <div class="snglCharacWrap characDetail">
			    ...
			    <form id="imageform" method="post" enctype="multipart/form-data" action='/i/p/p_f/u_p_img.php'>
		            ...
		            foreach($imagenes as $imgs)
		            {
		                ...
		                <div  class="uplddImgWrap">
		                    ...
		                    <span class="itmImageMask imageDefaultMask">
		                    	<img class="imageProduct imageDefault itmImage" <?php if($height > $width){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/productos/thumb150/<?php echo $imgs->img_temporales ?>">
		                    </span>
		                </div>
		                <?php
		            }
		    ...
		    <div class="characsWrap">
				...
				{
					?>
					<form class="caracteristica xtraCharacDetail characDetail transTw" action="/i/p/p_f/upl_caract.php">
...
*/
		$.ajax({
			type : "POST",
			url : "/i/p/p_f/upd_caract_temp.php",
...
<script type="text/javascript"> /* removes images from item on click */
     $('.addImgWrap').on('click','.itmImageMask',function(){
		...
		if($(this).hasClass('imageDefaultMask')){
			var funcURL = ("/i/p/p_f/borrar_img_producto_t.php");
		}
		
		else{
			var funcURL = ("/i/p/p_f/borrar_img_caracteristica_t.php");
		}
...
<script type="text/javascript"> /* removes characWrap */
	...
	function remmElem(){
     ...
     $('.characsWrap').on('click', '.removeCharacBtn', function(){
		...
		$.ajax({
			type: "POST",
			url: "/i/p/p_f/borrar_caracteristica_t.php",
			data: {idCar : id}
		})
