...
<div class="settWrap sentAdvWrapp">
	<form method="post" action="/i/solicitud"><button class="formActionBtn transTw addAdvbtn" type="submit">Agregar Solicitud</button></form>
	...
	<div class="advListBlock adverts">
		...
		foreach($publicidad as $p)
		{
			...
			<div  class="advDet <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>">
				...
				{
					?>
					<form method="POST" action="/i/p/publicidad_func/ren_publicidad.php">
...
<script>
	$('.removeA').click(function()
	{
		...
		$.ajax({
			type: "POST",
			url: "/i/p/publicidad_func/rem_publicidad.php",
