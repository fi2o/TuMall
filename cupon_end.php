...
<div class="genContentWrap group cupons-wrap"> 
	...
	foreach($cupon_usr->data as $c){
		...
		<div class="couponResumeWrap">
			...
			<a class="printBtn actionBtn" target="_blank" href="/i/reports/rep_cupon.php?id=<?php echo $c->idcupon_compras ?>">Versión para impresión</a>
		</div>
		<?php
	}
	?>
	
	<p class="coupEndSecondary">Puedes volver a ver esta información, y la lista de tus cupones, dando click en "<a href="/i/cliente/fav">Mi cuenta</a>" y luego en "<a href="/i/cliente/cupon">Cupones</a>". Ver <a href="/i/cliente/cupon">mis cupones</a>.</p>
