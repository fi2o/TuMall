...
<div class="genContentWrap group cupons-wrap"> 
				...
				foreach($imagenCupon->data as $ic)
				{
					...
					?> 
						<div class="smallPrev <?php echo $smallImgCount == 0 ? "selectedItem" : "" ?>">
							<img <?php if($height > $width){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/cupon/thumb150/<?php echo $ic->imagen ?>" />
						</div>
					<?php
 ...
 de descuento)</span></p>
			...
			{
				?>
				<form class="reserveCouponForm" method="post" action="/i/phpfn/add_cupon_usr.php">
	...
	?>
		...
		<div class="actionBar">
			...
			<a href="https://www.facebook.com/sharer.php?
				...
				&p[images][0]=http://www.tumall.do/i/images/cupon/<?php echo $imagenCupon->data[0]->imagen ?>
	...
	$('#itemDetailsWrapper').on('mouseenter', '.smallPrev', function(event){
		var hoverElem = $(this).children('img'),
			...
			if($(this).hasClass('alt')){
				...
				$('.itemMainPrev img').attr('src', '/i/images/cupon/' +previewSrc);
			}
