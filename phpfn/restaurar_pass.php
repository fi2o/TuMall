	...
	$message = '
		...
		<body>
			<div class="container">
				...
				<div class="body">
					<span>Para reiniciar su contraseña, por favor entra a este <a href="http://tumall.do/i/restaurarpass.php?id='. md5($usuario->idusuario) .'&e='. md5($usuario->correo) .'&cd=' . md5($usuario->fecha_creacion) . '">link</a></span>
				</div>
			</div>
		</body>
	</html>
