...
<div class="itemMainPrev">
	<img src="/i/images/c_prod/<?php echo $imagenC[0]->imagen ?>" alt="<?php echo $producto->nombre ?>" title="<?php echo $producto->nombre ?>"/>
</div>
<div class="itemSmallerPrevWrapper">
	...
	$pos = ($modVal - $baseDimm)/2
		...
		<div class="smallPrev alt <?php echo $smallImgCount == 0 ? "selectedItem" : "" ?>">
			<img <?php if($height > $width){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/c_prod/thumb150/<?php echo $iC->imagen ?>" alt="<?php echo $producto->nombre ?>" title="<?php echo $producto->nombre ?>"/>
		</div>
		<?php
		$smallImgCount++;
	}
...
<?php 
	...
	?>
	<div class="itemMainPrev">
		<img src="/i/images/productos/<?php echo $imagenproducto[0]->imagen ?>" alt="<?php echo $producto->nombre ?>" title="<?php echo $producto->nombre ?>" />
	</div>
	<div class="itemSmallerPrevWrapper">
		<?php 
		$smallImgCount = 0;
		...
		$pos = ($modVal - $baseDimm)/2
			...
			<div class="smallPrev <?php echo $smallImgCount == 0 ? "selectedItem" : "" ?>">
				<img <?php if($height > $width){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/productos/thumb150/<?php echo $iP->imagen ?>" alt="<?php echo $producto->nombre ?>" title="<?php echo $producto->nombre ?>"/>
			</div>
			<?php
			$smallImgCount++;
		}
