...
<div class="settWrap editOptionsWrap">
	...
	<form class="optionForm tabWrap editOptionsSec transTw optInfoSec" action="/i/cliente/ajustes_func/update_name_phone.php" method="post">
	...
	<form class="optionForm tabWrap editOptionsSec transTw optEmailSec hidden" action="/i/cliente/ajustes_func/change_mail.php" method="post">
	...
	<form class="optionForm tabWrap editOptionsSec transTw optPassSec hidden" action="/i/cliente/ajustes_func/change_pass.php" method="post"> 
	...
	<form class="tabWrap editOptionsSec transTw optSuspendSec hidden" action="/i/cliente/ajustes_func/suspend_user.php" method="post">
