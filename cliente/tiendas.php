...
<a class="tabItm" href="/i/cliente/fav">Wishlist</a>
...
<div class="favoritesWrap">
	...
	foreach($usuarios as $usr)
	{
		...
		<div class="faveItemWrap">
			<a class="itmImageMask itmListMask" href="/i/tienda/<?php echo $link . "-" . $usr->idusuario ?>"> 
			...
			<div class="faveItmDetails">
				<a  class="favStoreName" href="/i/tienda/<?php echo $link . "-" . $usr->idusuario ?>">
