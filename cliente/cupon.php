	...
	<div class="advListBlock reservedListWrap">
		...
		foreach($cupon_usr->data as $c){
			...
			<div class="advDet <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>">
				...
				<span class="advListItm couponStatus"><span class="helpText">Status: </span>[<?php echo $c->usado == 1 ? "Usado" : "No usado" ?>] <a href="/i/reports/rep_cupon.php?id=<?php echo $c->idcupon_compras  ?>">Imprimir</a></span>
			</div>
			<?php
		}
		?>
