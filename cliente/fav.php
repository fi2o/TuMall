	...
	if($total_prod > 0){
		...
		foreach($producto as $pro)
		{
			...
			<div class="faveItemWrap">
				<a class="itmImageMask itmListMask" href="/i/articulo/<?php echo $link."-".$pro->idproducto; ?>">
					<img class="itmListImg itmImage" <?php if($height > $width){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/productos/thumb150/<?php echo $pro->imagen ?>">
				</a>
				<div class="faveItmDetails">
					<a href="/i/articulo/<?php echo $link."-".$pro->idproducto; ?>"><?php echo $pro->nombre ?></a>
					<br />
					<a class="favStoreName" href="/i/<?php echo $link2. "-" . $pro->idusuario ?>"><?php echo $pro->nombretienda ?></a>
				</div>
...
<div class="favoritesWrap optionForm tabWrap transTw favSec hidden">
	...
	if($total_users > 0){
		...
		foreach($usuarios as $usr)
		{
			...
			?>
			<div class="faveItemWrap">
				<a class="itmImageMask itmListMask" href="/i/<?php echo $link . "-" . $usr->idusuario ?>"> 
					...
					<img class="itmListImg itmImage" <?php if($height > $width){  ?> width="<?php echo $baseDimm; ?>" height="<?php echo $modVal; ?>" style="top: -<?php echo $pos; ?>px;"  <?php }  else{ ?> height="<?php echo $baseDimm; ?>" width="<?php echo $modVal; ?>" style="left: -<?php echo $pos; ?>px;" <?php } ?> src="/i/images/profile/cr/<?php echo $usr->imagen ?>">
					...
					<img src="/i/images/resources/storePNG-100.png" alt="No user picture" width="65" height="65" />
				...
				<div class="faveItmDetails">
					<a  class="favStoreName" href="/i/<?php echo $link . "-" . $usr->idusuario ?>">
	...
	<p class="noContentMsg">Aún no has agregado ninguna tienda a tus favoritos, <a href="http://tumall.do/i/tiendas">agrega algunas</a>!</p>
