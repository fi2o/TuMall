...
<div class="settWrap recAdvWrapp certificates ">
	...
	<a class="tabItm requestTabs certTab active" href="/i/administracion/solicitudes">Certificados</a>
	<a class="tabItm requestTabs advertTab" href="/i/administracion/solicitudes1">Publicidad</a>
	<a class="tabItm requestTabs offerTab" href="/i/administracion/solicitudes2">Oferta</a>
			...
			if($total_pages > 1)
				{
					echo $pagecert == 1 ? 1 : (($pagecert-1)*$count_cert)+1 ?> al <?php echo $pagecert == $total_pages ? $total : ($pagecert*$count_cert) ?> de <span><?php echo $total; ?></span>
						...
						<a <?php echo $pagecert > 1 ? "href='http://tumall.do/i/administracion/solicitudes/page/$prevPage/'" : "" ?> class="pageCtrls prevPage"><i class="fa fa-angle-left"></i></a>
		
		
						<a <?php echo $pagecert < $total_pages ? "href='http://tumall.do/i/administracion/solicitudes/page/$nextPage/'" : "" ?> class="pageCtrls nextPage"><i class="fa fa-angle-right"></i></a>
	...
	foreach($certificado as $c)
	{
		...
		<div class="advDet <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>">
			...
			<a href="/i/administracion/certificado/<?php echo $c->idcertificacion ?>" class="advListDetItem advListItm advDescr"><span class="helpText">Titulo: </span><?php echo substr($c->texto,0,15); ?></a>
