...
<div class="settWrap recAdvWrapp adverts">
	...
	<a class="tabItm requestTabs certTab" href="/i/administracion/solicitudes">Certificados</a>
	<a class="tabItm requestTabs advertTab active" href="/i/administracion/solicitudes1">Publicidad</a>
			...
			if($total_pages > 1)
				{
					echo $pageadver == 1 ? 1 : (($pageadver-1)*$count_adv)+1 ?> al <?php echo $pageadver == $total_pages ? $total : ($pageadver*$count_adv) ?> de <span><?php echo $total; ?></span>
						...
						<a <?php echo $pageadver > 1 ? "href='http://tumall.do/i/administracion/solicitudes1/page/$prevPage/'" : "" ?> class="pageCtrls prevPage"><i class="fa fa-angle-left"></i></a>
		
		
						<a <?php echo $pageadver < $total_pages ? "href='http://tumall.do/i/administracion/solicitudes1/page/$nextPage/'" : "" ?> class="pageCtrls nextPage"><i class="fa fa-angle-right"></i></a>
		...
		<?php 
			...
			foreach($publicidad as $p)
			{
				...
				<div  class="advDet <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>">
					...
					<a href="/i/administracion/anuncio/<?php echo $p->idofertas ?>" class="advListDetItem advListItm advDescr"><span class="helpText">Titulo: </span><?php echo $p->titulo ?></a>
