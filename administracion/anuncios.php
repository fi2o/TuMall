...
<div class="settWrap applyAdvertsWrap">
	...
	<div>
		...
		<a class="tabItm" href="/i/administracion/tiendas">Tiendas destacadas</a>
		<a class="tabItm active" href="/i/administracion/anuncios">Anuncios</a>
	</div>
	<form class="addPubForm displayAdvertForm" method="post" action="/i/administracion/pub_func/add_adver.php" enctype="multipart/form-data">
	...
	<div class="bannerRightWraper adminBannerWrap">
		...
		foreach($anuncios as $a)
		{
			...
			<div class="itemDetWrapp transTw userDetailWrapper pubWrapperDetail <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>" >
				<img class="right-ad-thumb" src="/i/images/publicidad/<?php echo $a->image ?>">
				...
				<div class="itmListBtnWrapp">
					...
					<form method="post" action="/i/administracion/pub_func/finish_anuncio.php">
	...
	<div class="bannerTopWraper adminBannerWrap">
		...
		foreach($anuncios as $a)
		{
			?>
			<div class="itemDetWrapp transTw userDetailWrapper pubWrapperDetail <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>" >
				<img class="top-ad-thumb" src="/i/images/publicidad/<?php echo $a->image ?>">
				<br />
				<div class="itmListDescrWrap">
					<span class="itmListName transOn itmListDescr">Link: <?php echo $a->link; ?></span>
					<?php 
...
<script>
	$('.removeOffer').click(function(){
		...
		$.ajax({
			type : "POST",
			url : "/i/administracion/pub_func/remove_anun.php",
