...
<div class="settWrap recAdvWrapp offers">
	...
	<a class="tabItm requestTabs offerTab active" href="/i/administracion/solicitudes2">Oferta</a>
			...
			if($total_pages > 1)
				{
					echo $pageoff == 1 ? 1 : (($pageoff-1)*$count_offer)+1 ?> al <?php echo $pageoff == $total_pages ? $total : ($pageoff*$count_offer) ?> de <span><?php echo $total; ?></span>
						...
						<a <?php echo $pageoff > 1 ? "href='http://tumall.do/i/administracion/solicitudes2/page/$prevPage/'" : "" ?> class="pageCtrls prevPage"><i class="fa fa-angle-left"></i></a>
		
		
						<a <?php echo $pageoff < $total_pages ? "href='http://tumall.do/i/administracion/solicitudes2/page/$nextPage/'" : "" ?> class="pageCtrls nextPage"><i class="fa fa-angle-right"></i></a>
		...
		<div class="advListHead">
			...
			foreach($publicidad as $p)
			{
				...
				<div  class="advDet <? if($oddCnt%2==1){ echo "odd";} $oddCnt++  ?>">
					...
					<a href="/i/administracion/oferta/<?php echo $p->idofertas ?>" class="advListDetItem advListItm advDescr"><span class="helpText">Titulo: </span><?php echo $p->titulo ?></a>
