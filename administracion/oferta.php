...
<div class="settWrap requestFormWrap adminReviewWrap">
	<div class="requestForm shown">
		...
		if(!empty($oferta->imagen))
		{
			...
			<div class="requFileWrap">
				<div class="newImage">
					<img src="/i/images/publicidad/<?php echo $oferta->imagen ?>">
				</div>
			</div>
			<?php
		}
		...
		<div>
			...
			foreach($ofertaProductos as $producto)
			{
				...
				<div class="previewWrapper">
					...
					{
					?>
						<a href="/i/articulo/<?php echo $link."-".$producto->idproducto; ?>" class="pictureWrapper"><img src="/i/images/productos/thumb50/<?php echo $producto->imagen ?>" alt="resource1"></a>
					<?php 
					}
					?>
					</div>
					<a href="/i/articulo/<?php echo $link."-".$producto->idproducto; ?>" class="pictureWrapper"><h4><?php echo $producto->nombre ?></h4></a>
					<span>
					...
					<?php 
						...
						{
							?> 
							<form class="addPubForm" method="post" action="/i/administracion/pub_func/add_item_pub_off.php">
	...
	<div class="ctrlBtnWrap requ-CtrlBtnWrap">
		<a class="formActionBtn back transTw" href="/i/administracion/solicitudes1">Volver</a>
...
<script>
	$('.changeStat').click(function()
	{
		...
		$.ajax({
			type : "POST",
			url : "/i/administracion/cert_func/change_adver_status.php",
