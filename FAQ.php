...
<div class="businessInfoWrap">	
	...
	<p>Si, debes subir tus propios artículos a la plataforma, puedes hacerlo a través de tu PC o Smartphone. En caso de necesitar ayuda, puedes <a href="/i/contacto">contactarnos</a> y te ayudaremos.</p>
	...
	<p>Primero <a href="/i/registro">regístrate</a> y, luego de validar tu cuenta, simplemente accede a "Mi cuenta", y desde allí ve a "Publicar". Sigue los pasos en pantalla e intenta proveer tanta información como puedas sobre tu artículo.</p>
	...
	<ul>
		...
		<li>Finalmente, hacemos publicidad directa de las tiendas, es decir, en el <a href="/i/home">landing page/home page</a> aparecerán hasta 6 tiendas destacadas, estos espacios son rotatorios.</li>
	</ul>
	<br />
	...
	<p>Puedes enviar una solicitud de certificación a través del panel de tienda, dando click en "Publicidad", y luego en "Agregar Solicitud", o bien, dando <a href="http://tumall.do/i/solicitud">click aquí</a>. También puedes solicitar tu CFT vía correo electrónico a <a href="mailto:info@tumall.do">info@tumall.do</a>.</p>
...
Recibe un ranking A+ por encima de otras tiendas no certificadas, y obtiene en los anuncios y ofertas que nos envíe para ser publicados. Además, un sello distintivo que la diferencia de las tiendas no certificadas, y capacidades de edición de artículos avanzadas, como un editor full HTML para poder dar un estilo característico y único a tus artículos.</p>
	...
	<p>Sí, para más detalles <a href="/i/contacto">contáctanos a servicio al cliente</a>.</p>
