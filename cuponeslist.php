	...
	<?php if($cupon->rowcount)
		{
			...
			<div class="featuredCoupon">
				...
				<div class="itemMainPrev">
					...
					{
						?>
						<a href="/i/cupon/<?php echo $link . '-' . $cupon->data[0]->idcupon;  ?>">
							<img src="/i/images/cupon/<?php echo $imagenCupon->data[0]->imagen ?>" alt="<?php echo $cupon->data[0]->titulo; ?>" title="<?php echo $cupon->data[0]->titulo; ?>" />
						</a>
						<?php 
					}
				...
				<div class="itemInfoWrapper couponInfoWrap">	
					<h2 class="itemName"><a href="/i/cupon/<?php echo $link . '-' . $cupon->data[0]->idcupon;  ?>"><?php echo $cupon->data[0]->titulo; ?></a></h2>
			 ...
			 de descuento)</span></p>
					...
					<br />
					<a class="buyButton orderButton transOn actionBtn" href="/i/cupon/<?php echo $link . '-' . $cupon->data[0]->idcupon;  ?>">Reservar cupón</a>
		...
		<div class="storeDisplayContent">
			...
			foreach($cupones->data as $c)
			{
				...
				?>
				<div class="itemWrap">
					<a href="/i/cupon/<?php echo $link . '-' . $c->idcupon;  ?>" class="itemImg">
						<?php 
							if(empty($c->imagen)){
							?>
								<img src="/i/images/NoImage.png" alt="No image" />
							...
							?>
								<img src="/i/images/cupon/thumb400/<?php echo $c->imagen ?>" alt="<?php echo $c->titulo ?>" title="<?php echo $c->titulo ?>" />
							<?php 
							}
							?>
					</a>
					<div class="itemDescrip">
						<?php 
							...
							?>
							<a class="itemListName"  href="/i/cupon/<?php echo $link . '-' . $c->idcupon;  ?>"><?php echo $c->titulo ?></a>
							<br />
