		...
		<div class="backendButtonsPane">
            <div class="profilePicWrapper">
				<div class="userProfilePic transTw">
					<img src="/i/images/resources/userPNG-admin-100.png" alt="No user picture" />
				</div>
				<span>Hey, Admin!</span>
			</div>
			<a href="/i/administracion/usuarios" class="settMenuItm adminUsrs <?php if(strpos($URL, '/i/administracion/usuarios') === 0 || strpos($URL, '/i/administracion/usr') === 0){ echo 'active'; } ?>">Usuarios</a>        
			<a href="/i/administracion/solicitudes" class="settMenuItm usrAdvert <?php if(strpos($URL, '/i/administracion/solicitudes') === 0){ echo 'active'; } ?>">Solicitudes</a>
			<a href="/i/administracion/publicidad" class="settMenuItm usrAdvert <?php if(strpos($URL, '/i/administracion/publicidad') === 0){ echo 'active'; } ?>">Publicidad</a>
			<a href="/i/administracion/galeria" class="settMenuItm usrAdvert <?php if(strpos($URL, '/i/administracion/galeria') === 0){ echo 'active'; } ?>">Galeria</a>
			<a href="/i/administracion/cupones" class="settMenuItm usrStore <?php if(strpos($URL, '/i/administracion/cupones') === 0){ echo 'active'; } ?>">Cupones</a>
			<a href="/i/administracion/ajustes" class="settMenuItm usrPrefs <?php if(strpos($URL, '/i/administracion/ajustes') === 0){ echo 'active'; } ?>">Ajustes</a>
