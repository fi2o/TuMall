<?php 
							require_once('phpfn/stringmanager.php');
							  	...
							  	foreach($categoria1 as $c1)
								{
									...
									?>
									<h3 class="resultsSubCategory"><a href="/i/lista/categoria/<?php echo $link . "-" . $c1->idcategoria1 ?>/
									...
									if(!empty($categoria2))
									{
										...
										foreach($categoria2 as $c2)
										{
											...
											$link = preg_replace('/[^A-Za-z0-9\-]/', '', $link);
											?>
											<li><h4><a class="last-category" href="/i/lista/categoria2/<?php echo $link . "-" . $c2->idcategoria2 ?>/
