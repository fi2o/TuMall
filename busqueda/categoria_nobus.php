<?php 
							  	...
							  	foreach($categoria1 as $c1)
								{
									...
									?>
									<h5 class="resultsSubCategory"><a href="/i/lista/categoria/<?php echo $link . "-" . $c1->idcategoria1 ?>/"><?php echo $c1->descripcion ?></a></h5>
									<?php
									...
									if(!empty($categoria2))
									{
										...
										foreach($categoria2 as $c2)
										{
											...
											$link = preg_replace('/[^A-Za-z0-9\-]/', '', $link);
											?>
											<li><a href="/i/lista/categoria2/<?php echo $link . "-" . $c2->idcategoria2 ?>/"><?php echo $c2->descripcion ?></a></li>
											<?php
										}
										?>
										</ul>
								...
								?>
								<span><a href="/i/lista">Ver otras categorías</a></span>