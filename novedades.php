...
if(!empty($anuncio[0]->image))
{
	?>
	<div class="adTop ads">
	<a href="<?php echo $anuncio[0]->link ?>"><img src="/i/images/publicidad/<?php echo $anuncio[0]->image ?>"></a>
	</div>
	<?php 
}
?>
			...
			foreach($categorias as $c1)
				{
					...
					<?php
						...
						?>
						<a href="/i/lista/categoria/<?php echo $link . "-" . $c1->idcategoria1 ?>/"><?php echo $c1->descripcion ?></a>
					</h3>
						<?php
				}
	...
	<div class="newItemsWrap group">
				...
				<div class="featContWrap transTh group hmFeatStore active">
					...
					foreach($usuarios as $u)
					{
						...
						$link = preg_replace('/[^A-Za-z0-9\-]/', '', $link);
						?>
						<a href="/i/<?php echo $link ?>-<?php echo $u->idusuario ?>/" class="hmFeatItm stores" style="background:url(
							<?php 
							if(!empty($u->banner1))
							{
								echo "'/i/images/banners/cr/$u->banner1'";
								
							}
							else {
								echo '/i/images/resources/defaultBanner.png';								
							}
							?>
							...
							<span class="featuredPreview storePreview">
								...
								{
									?>
									<img src="/i/images/resources/storePNG-100.png" >
									<?php
									
								}
								else {
									?>
									<img src="/i/images/profile/cr/<?php echo $u->imagen ?>" >
									<?php	
								}
								?>
					...
					$query = $con->prepare('SELECT  p.idproducto ,p.nombre, p.precio, p.preciooferta, p.enoferta, ip.imagen, p.moneda
							...
							foreach($productos as $p)
							{
								...
								<div class="featItem">
									...
									?>
									<a class="imgMask" href="/i/articulo/<?php echo $link ?>-<?php echo $p->idproducto ?>">
										<span class="maskMidle">
											<img src="/i/images/productos/thumb200/<?php echo $p->imagen ?>" >
										</span>
									</a>
									<a class="featItmName" href="/i/articulo/<?php echo $link ?>-<?php echo $p->idproducto ?>"><?php echo $p->nombre ?></a>
					...
					$query = $con->prepare('SELECT  p.idproducto ,p.nombre, p.precio, p.preciooferta, p.enoferta, ip.imagen, p.moneda
							...
							foreach($productosOferta as $p)
							{
								...
								<div class="hmFeatItm articles">
									<a class="featuredPreview itemPreview" href="/i/articulo/<?php echo $link ?>-<?php echo $p->idproducto ?>">
										<img src="/i/images/productos/thumb150/<?php echo $p->imagen ?>" >
										<i class="helper"></i>
									</a>
									<a class="ftItmName" href="/i/articulo/<?php echo $link ?>-<?php echo $p->idproducto ?>"><?php echo $p->nombre ?></a>
