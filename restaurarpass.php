...
<div class="registerWrapp loginWrapp">
	...
	<a href="/i/home" class="regLogo"><img src="/i/images/logo-min-NS.png" alt="Logo TuMall" class="replace2X" /></a>
	
	<h2 class="welcomMsg">Contraseña nueva</h2>
	
	<form method="post" class="registerForm restore"  action="/i/phpfn/resetear_pass.php?id=<?php echo $_GET["id"] ?>&e=<?php echo $_GET["e"] ?>&cd=<?php echo $_GET["cd"] ?>">
